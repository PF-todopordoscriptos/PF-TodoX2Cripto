...
const AdminDashboardWarnings = () => {
  ...
  return (
    <div>
        ...
        {allWarnings.length ? allWarnings.map((c) => (
            <WarningAdmin
            key={c.id}
            id={c.id}
            email={c.email}
        ...
        <div className={style.loading}>
            <img src="https://freight.cargo.site/t/original/i/cc1c0bea6bb22eaba0ea154629f5c1f347fd093d843b20a37756fe27998c3031/Dino_Flip.gif" alt="gif dino" className={style.dino}/>
