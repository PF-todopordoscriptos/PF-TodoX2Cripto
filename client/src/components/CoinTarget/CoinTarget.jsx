      ...
      <div className={style.icon}>
        {favoriteClicked ? (
          <IconButton aria-label="" onClick={removeFavoriteCoin}>
            ...
            <IconButton className={style.icon} aria-label="" onClick={addFavoriteCoin}>
        ...
        <h3 className={props.price_change_percentage_24h > 0 ? style.percentageGreen : style.percentageRed}>{props.price_change_percentage_24h.toFixed(2)}%</h3>
