    ...
    <div className={style.all}>
      <CardMedia
        sx={{
          ...
          backgroundImage: `url(${Brontosaurio})`,
          width: "100%",
          height: "90rem",
          backgroundSize: "41%",
        }}
      ...
      <div className={style.trending}>
        ...
        <Typography
          variant={"h1"}
          sx={{
            color: "landingPage.upperHeader.color",
            ...
            <Button
              sx={{
                ":hover": {
                  ...
                  transition: ".2s;",
                  backgroundColor: "landingPage.button.background",
                },
                transition: ".2s;",
                backgroundColor: "landingPage.button.background",
                color: "landingPage.button.text",
                borderBottom: 3,
                borderColor: "landingPage.button.border",
                fontWeight: 700,
                fontSize: 16,
                borderRadius: "16px",
                width: "12.5vw",
      ...
      <div className={style.abajo}>
        <div>
          ...
          <Typography
            variant={"h1"}
            sx={{
              color: "landingPage.lowerHeader.color",
              fontFamily: "'Lato', sans-serif",
              fontSize: "80px",
            }}
          >
